...
public:
     ...
     */
    OMI_API_EXPORT static Type kTypeInt64;
     ...
     */
    OMI_API_EXPORT Int64Attribute(DataType value, bool immutable = true);
     ...
     */
    OMI_API_EXPORT Int64Attribute(const Attribute& other);
     ...
     */
    OMI_API_EXPORT Int64Attribute(const Int64Attribute& other);

    //--------------------------------------------------------------------------
    //                                 DESTRUCTOR
    //--------------------------------------------------------------------------

    OMI_API_EXPORT virtual ~Int64Attribute();
