...
public:
     ...
     */
    OMI_API_EXPORT static Type kTypeFloat;
     ...
     */
    OMI_API_EXPORT FloatAttribute(DataType value, bool immutable = true);
     ...
     */
    OMI_API_EXPORT FloatAttribute(const Attribute& other);
     ...
     */
    OMI_API_EXPORT FloatAttribute(const FloatAttribute& other);

    //--------------------------------------------------------------------------
    //                                 DESTRUCTOR
    //--------------------------------------------------------------------------

    OMI_API_EXPORT virtual ~FloatAttribute();
