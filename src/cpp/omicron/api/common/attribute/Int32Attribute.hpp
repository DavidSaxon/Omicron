...
public:
     ...
     */
    OMI_API_EXPORT static Type kTypeInt32;
    ...
    /*!
     * \brief Constructs a new empty immutable Int32Attribute with a tuple size
     *        of 0.
     */
    OMI_API_EXPORT Int32Attribute();
     ...
     */
    OMI_API_EXPORT Int32Attribute(DataType value, bool immutable = true);
     ...
     */
    OMI_API_EXPORT Int32Attribute(const Attribute& other);
     ...
     */
    OMI_API_EXPORT Int32Attribute(const Int32Attribute& other);

    //--------------------------------------------------------------------------
    //                                 DESTRUCTOR
    //--------------------------------------------------------------------------

    OMI_API_EXPORT virtual ~Int32Attribute();
