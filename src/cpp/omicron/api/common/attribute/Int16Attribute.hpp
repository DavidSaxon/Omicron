...
public:
     ...
     */
    OMI_API_EXPORT static Type kTypeInt16;
    ...
    /*!
     * \brief Constructs a new empty immutable Int16Attribute with a tuple size
     *        of 0.
     */
    OMI_API_EXPORT Int16Attribute();
     ...
     */
    OMI_API_EXPORT Int16Attribute(DataType value, bool immutable = true);
     ...
     */
    OMI_API_EXPORT Int16Attribute(const Attribute& other);
     ...
     */
    OMI_API_EXPORT Int16Attribute(const Int16Attribute& other);

    //--------------------------------------------------------------------------
    //                                 DESTRUCTOR
    //--------------------------------------------------------------------------

    OMI_API_EXPORT virtual ~Int16Attribute();
