...
/*!
 * \brief The stride of a geometry position (in floats).
 */
...
OMI_API_GLOBAL omi::Attribute OBJLoader::load(arc::io::sys::FileReader& reader)
{
    // TODO: REMOVE ME
    ...
    while(!reader.eof())
    {
        ...
        else if(line.starts_with("f"))
        {
            ...
            // TODO: REMOVE ME
            // std::cout
            //     << "point_positions size: " << point_positions.size()
            //     << std::endl;
...
// TODO: need to register and probably can just moved to cpp function
